...
<table border="1" cellpadding="10" cellspacing="3" class="naglowek">
    <tr>
        ...
        <td>
            ...
            <h3 align="center"><?php if($typ == 'oryginal'){ ?>ORYGINAŁ<?php }else if($typ == 'kopia'){ ?>KOPIA<?php }else if($typ == 'duplikat'){ ?>ORYGINAŁ - DUPLIKAT<?php }else{ ?>PODGLĄD<?php } ?></h2>
        ...
        <td>
            ...
            Data sprzedaży: <?php echo czytelna_data($faktura['data_sprzedazy']);?>
            <?php if($typ == 'duplikat'){ ?><br /><br />Duplikat wystawiono: <?php echo czytelna_data(date("Y-m-d"));?><?php } ?>
        </td>
    </tr>
</table>
