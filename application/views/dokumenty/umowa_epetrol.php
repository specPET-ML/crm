...
<li>Wykonawca w uzgodnieniu ze Zlecającym może raz na 2 tygodnie modelować frazy, jeśli bieżące analizy pozycji wskażą działanie za uzasadnione, aby uzyskać lepsze efekty pozycjonowania. </li>
<li> Zlecający w uzgodnieniu z Wykonawcą może dodać lub zamienić frazy np. w wyniku dodania nowych produktów. Liczba monitorowanych fraz nie przekroczy w takim przypadku ilości ustalonej w załączniku do umowy. </li>
</ol> 
...
<li><b>Zlecający</b> zobowiązuje się do:
    <ol type="a">
        <li>wyznaczenia osoby odpowiedzialnej za edycję plików źródłowych strony WWW Zlecającego i obsługę systemu CMS , która na wezwanie Wykonawcy, dla potrzeb optymalizacji kodu Strony WWW będzie mogła dokonać rekomendowanych przez Wykonawcę zmian w strukturze i treści Strony WWW</li>
...
<li><b>Zlecający</b> wyraża zgodę na przesyłanie faktur VAT drogą elektroniczną w formie plików PDF lub równoważnych, gwarantujących integralność zawartych danych. Faktury będą przesyłane na następujący adres e-mail <b>Zlecającego</b>:<strong> efaktura.koszty@e-petrol.pl</strong></li>
...
<li>W przypadku naruszenia przez<b> Wykonawcę</b><strong> </strong>obowiązku zachowania w poufności informacji, o którym mowa w niniejszym paragrafie, będzie on zobowiązany do zapłaty na rzecz <b>Zlecającego </b>kary umownej w kwocie odpowiadającej trzykrotności należności wskazanej w ostatniej wystawionej przez <b>Wykonawcę</b> na rzecz <b>Zlecającego</b> fakturze VAT.<b> Zlecający</b><strong> </strong>jest uprawniony do dochodzenia odszkodowania przewyższającego wysokość zastrzeżonej kary umownej.</li>
...
<li>W przypadku naruszenia przez Wykonawcę obowiązku poufności, o którym mowa w § 6, <b>Zlecający </b> może rozwiązać niniejszą umowę ze skutkiem natychmiastowym. Niezależnie od rozwiązania umowy, <b>Zleceniodawca</b> jest uprawniony do naliczenia kary umownej stosownie do § 6, jak również do żądania odszkodowania przenoszącego wysokość zastrzeżonej kary.</li>
<li><b>Wykonawca</b> jest uprawniony do rozwiązania umowy ze skutkiem natychmiastowym w przypadku zaległości <b>Zlecającego</b> w zapłacie należności za dwa okresy płatności tj. kwot wynikających z dwóch ostatnich wystawionych przez <b>Wykonawcę</b> faktur.</li>
</ol>
