...
<li>W ramach Optymalizacji Pozycji <b>Wykonawca</b> zobowiązuje się w szczególności do:
    <ol type="a">
        ...
        <li>osiągnięcie w/w wyniku nastąpi w ciągu do 2 tygodni od rozpoczęcia działań (minimum 40% fraz z załącznika nr 1). W   przeciwnym wypadku Zlecający może rozwiązać niniejszą umowę bez zachowania   okresu wypowiedzenia</li>
    </ol>
</li>
...
<li><b>Zlecający</b> zobowiązuje się do:
    <ol type="a">
        <li>przekazania na wezwanie <b>Wykonawcy</b>, dla potrzeb wykonania optymalizacji kodu <b>Strony WWW</b>,kontaktu z administratorem strony</li>
...
<li><b>Zlecający</b> oświadcza, że nie korzysta, jak również nie będzie korzystał w trakcie obowiązywania niniejszej umowy, z usług innych podmiotów zajmujących się pozycjonowaniem strony www <U>będącej przedmiotem niniejszej   umowy</U>.</li>
...
<li>Kwota wynagrodzenia o którym mowa w ust. 2 powyżej płatna będzie w terminie do 21 dni każdego miesiąca w którym usługa będzie wykonywana, na podstawie faktury VAT.</li>
...
<li>Wszelkie spory wynikłe z wykonywania postanowień niniejszej Umowy <b>Strony</b> zobowiązują się rozwiązywać polubownie na drodze negocjacji. W razie braku porozumienia spory rozstrzygał będzie sąd właściwy dla miejsca siedziby <b>Zlecającego</b>.</li>
<li>Umowę sporządzono w 2 jednobrzmiących egzemplarzach, po jednym dla każdej ze <b>Stron</b>.</li>
<li>Zleceniobiorca zobowiązuje   się, że po zakończeniu współpracy lub w momencie wstrzymania świadczenia usług   linki wspomagające proces optymalizacji strony, nie
  zostaną usunięte jednorazowo,   a będą one usuwane stopniowo w przeciągu minimum 3 miesięcy oraz że linki   nie
  będą wstawiane w systemie   wymiany linków ani nie będą one pochodziły z farm linków.</li>
