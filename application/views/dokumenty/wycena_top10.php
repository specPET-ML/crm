    ...
    <body>
        ...
        <table border="1" cellpadding="10" cellspacing="0" class="top_10">
            <tr>
                ...
                <?php if($klient['top_10_3_od'] && $klient['top_10_3_do']){ ?><td align="center" bgcolor="#555" color="#FFF">Pozycje <?php echo $klient['top_10_3_od'];?>-<?php echo $klient['top_10_3_do'];?></td><?php } ?>
            </tr>
            <?php foreach($frazy as $fraza){ ?>
                <?php if($fraza['typ'] == 1){ ?>
            <tr>
