    ...
    if($frazy){
        ...
        foreach($frazy as $fraza){
            ...
            if($fraza['typ'] == 2){
                ...
                $pod_tytul .= '<br />';
// dirty hack   $pod_tytul .= 'Kwota dla klienta: <b style="color: #333;">'.$fraza['kwota_za_fraze'].' zł</b>';
                $pod_tytul .= 'Kwota dla klienta: <b style="color: #333;">'.$fraza['kwota_za_fraze'].' zł</b><br /> Przedziały top 10:<br /> p1:<b>'.$fraza['top10_1_kwota'].'</b><br />'.''; // szybki dirty hack na przedzialy
            }
            $pod_tytul .= '</div>';
