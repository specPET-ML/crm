...
<?php if ($uzytkownik['typ'] == 'admin') { ?>
	...
	<?php } ?>
	<?php if($uzytkownik['id'] == '1' || $uzytkownik['id'] == '10' || $uzytkownik['id'] == '4' || $uzytkownik['id'] == '6' || $uzytkownik['id'] == '126'){ ?>
...
<!--	<?php if ($uzytkownik['id'] == '5' || $uzytkownik['id'] == '6'  || $uzytkownik['id'] == '10' || $uzytkownik['id'] == '125'){ ?>
		<div class="portlet">
