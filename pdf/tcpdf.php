	...
	*/
	class TCPDF {
		...
		public function Header() {
			...
			$this->SetLineStyle(array('width' => 0.85 / $this->getScaleFactor(), 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(200, 200, 200)));
		...
		public function Footer() {
			...
			$this->SetLineStyle(array('width' => $line_width, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(200, 200, 200)));
			...
			if (empty($this->pagegroups)) {
				$pagenumtxt = (isset($this->footer_text) && !empty($this->footer_text) ? ($this->footer_text).', ' : '' ) . $this->l['w_page'].' '.$this->getAliasNumPage().' / '.$this->getAliasNbPages();
			} else {
				$pagenumtxt = (isset($this->footer_text) && !empty($this->footer_text) ? ($this->footer_text).', ' : '' ) . $this->l['w_page'].' '.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias();
			}
			$this->SetY($cur_y);
			//Print page number
			if ($this->getRTL()) {
