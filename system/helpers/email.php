...
class email
{
	...
	public function send()
	{
		...
		if(count($this->attachments) > 0)
		{
			...
			$alt_content_attachment->content($this->content,'text/html',array('charset'=>'iso-8859-2'));
			$alt_content[] = (String) $alt_content_attachment;
			
			// Plain text multipart alternative
			/*$alt_content_attachment = new email_attachment();
			$alt_content_attachment->content(strip_tags($this->content),'text/plain',array('charset'=>'iso-8859-2'));
			$alt_content[] = (String) $alt_content_attachment;*/
